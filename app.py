...
# fallback if strict filter returns nothing
    ...
    f"What is the percentage contribution of BFSI or Financial Segment reported for quarter {quarter} in year {year}?If you are getting the exact value of the contibution by BFSI, then please calculate percentage and return that from pdf. Extract only numeric value, return like: 23.5",
